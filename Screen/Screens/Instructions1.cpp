...
Instructions1::Instructions1(ScreenConstructionParameters parameters) : level(parameters.spriteSheet, parameters.textureRectangles),
                                                                                                            ...
                                                                                                            nextButton(parameters.mainFont, parameters.activeButtonTexture, parameters.inactiveButtonTexture, parameters.clickSound)
{
    ...
    level.setData(LevelList::getLevels()[9]);
...
void Instructions1::draw(sf::RenderTarget & target, const TransitionInfo & transition)
{
...
double Instructions1::getTransitionInTime() {return 1;}
double Instructions1::getTransitionOutTime() {return 1;}